...
void Divisas() {
  ...
  print(
    '$chelinesAustriacos ATS equivalen a ${pesetasDesdeATS.toStringAsFixed(3)} Pesetas.',
  );
  ...
  print(
    '$dracmasGriegos GRD equivalen a ${francosFrancesesDesdeGRD.toStringAsFixed(3)} Francos Franceses.',
  );
  ...
  print(
    '$pesetasInput Pesetas equivalen a ${dolaresDesdePesetas.toStringAsFixed(3)} Dólares EEUU.',
  );

  double lirasItalianasDesdePesetas = pesetasInput / pesetasPorLiraItaliana;
  print(
    '$pesetasInput Pesetas equivalen a ${lirasItalianasDesdePesetas.toStringAsFixed(3)} Liras Italianas.',
  );
}
