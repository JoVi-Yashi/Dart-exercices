...
void idenFiguraGeometrica() {
  ...
  print('\n=== ANÁLISIS ===');
  print(
    'Área del triángulo (base=$valor1, altura=$valor2): ${areaTriangulo.toStringAsFixed(2)}',
  );
  print(
    'Área del círculo (radio=$valor1, pi=$valor2): ${areaCirculo.toStringAsFixed(2)}',
  );
  print(
    'Área del rectángulo (base=$valor1, altura=$valor2): ${areaRectangulo.toStringAsFixed(2)}',
  );
