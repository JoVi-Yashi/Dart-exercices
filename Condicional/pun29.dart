...
void incentivoVendedores() {
  ...
  print(
    'Límite para incentivo (33%): Bs. ${limiteIncentivo.toStringAsFixed(2)}',
  );
  ...
  if (ventas1 > limiteIncentivo) {
    ...
    print(
      'Departamento 1: Bs. ${pagoDepto1.toStringAsFixed(2)} (con incentivo)',
    );
  } else {
    pagoDepto1 = salarioBase;
    print(
      'Departamento 1: Bs. ${pagoDepto1.toStringAsFixed(2)} (sin incentivo)',
    );
  }
  ...
  if (ventas2 > limiteIncentivo) {
    ...
    print(
      'Departamento 2: Bs. ${pagoDepto2.toStringAsFixed(2)} (con incentivo)',
    );
  } else {
    pagoDepto2 = salarioBase;
    print(
      'Departamento 2: Bs. ${pagoDepto2.toStringAsFixed(2)} (sin incentivo)',
    );
  }
  ...
  if (ventas3 > limiteIncentivo) {
    ...
    print(
      'Departamento 3: Bs. ${pagoDepto3.toStringAsFixed(2)} (con incentivo)',
    );
  } else {
    pagoDepto3 = salarioBase;
    print(
      'Departamento 3: Bs. ${pagoDepto3.toStringAsFixed(2)} (sin incentivo)',
    );
  }
}
